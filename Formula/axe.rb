class Axe < Formula
  ...
  url "https://github.com/cameroncooke/AXe/releases/download/v1.8.0/AXe-macOS-homebrew-v1.8.0.tar.gz"
  sha256 "87eb09cd49dfc74fa8f7f5a46a03dfe2f14518b01d819f6a4094eab0d344ea7f"
